...
return $this->render('GestUser/admin/user/ResetPassword.html.twig', [
...
return $this->render('GestUser/user/code.html.twig', [
    'form' => $form->createView(),
]);
}
...
return $this->render('GestUser/user/PassUpdate.html.twig', [
    'form' => $form->createView(),
]);
}
